...
.detect:
	...
	ld	a, ' '
	call	CHPUT
	in	a, (SPISTATUS)	; Is there an SD Card in the slot?
	and	$2
	jr	z, .naoVazio
	ld	de, strVazio	; nop
	call	printString
...
isWrite:
	in	a, (SPISTATUS)	; destructive read
