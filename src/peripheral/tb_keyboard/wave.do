...
add wave -noupdate -radix hexadecimal /tb/u_target/idata_s
add wave -noupdate /tb/u_target/idata_rdy_s
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {6207 ns} 0}
...
update
WaveRestoreZoom {4746 ns} {8502 ns}
